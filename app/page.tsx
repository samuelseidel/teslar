        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 hover:border-red-500/50 transition-colors">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">1. Find an Ambassador</h3>
              <p className="text-gray-300">
                Browse Tesla owners in your area who are willing to share their experience and give you a test drive.
              </p>
            </div>
