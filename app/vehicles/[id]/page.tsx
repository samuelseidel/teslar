              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-2xl border border-white/20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {vehicle.vin && (
                    <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <p className="text-gray-400 text-sm font-medium">VIN</p>
                      </div>
                      <p className="text-white text-sm font-mono break-all">{vehicle.vin}</p>
                    </div>
                  )}
                  ...
                  {vehicle.vehicle_registry_data && (
                    <>
                      {/* Power */}
                      {vehicle.vehicle_registry_data.MotorMaxVykon && (
                        <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                          <div className="flex items-center gap-2 mb-2">
                          ...
                          <p className="text-white text-lg font-semibold">{vehicle.vehicle_registry_data.MotorMaxVykon} kW</p>
                        </div>
                      )}

                      {/* Fuel Type */}
                      {vehicle.vehicle_registry_data.Palivo && (
                        <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                          <div className="flex items-center gap-2 mb-2">
                            <svg className="w-5 h-5 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                            </svg>
                            <p className="text-gray-400 text-sm font-medium">Fuel Type</p>
                          </div>
                          <p className="text-white text-lg font-semibold">{vehicle.vehicle_registry_data.Palivo}</p>
                        </div>
                      )}

                      {/* Body Type */}
                      {vehicle.vehicle_registry_data.KaroserieDruh && (
                        <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                          <div className="flex items-center gap-2 mb-2">
                            <svg className="w-5 h-5 text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                            </svg>
                            <p className="text-gray-400 text-sm font-medium">Body Type</p>
                          </div>
                          <p className="text-white text-lg font-semibold">{vehicle.vehicle_registry_data.KaroserieDruh}</p>
                        </div>
                      )}

                      {/* Color */}
                      {vehicle.vehicle_registry_data.VozidloKaroserieBarva && (
                        <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                          <div className="flex items-center gap-2 mb-2">
                            <svg className="w-5 h-5 text-pink-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" />
                            </svg>
                            <p className="text-gray-400 text-sm font-medium">Color</p>
                          </div>
                          <p className="text-white text-lg font-semibold">{vehicle.vehicle_registry_data.VozidloKaroserieBarva}</p>
                        </div>
                      )}

                      {/* Category */}
                      {vehicle.vehicle_registry_data.Kategorie && (
                        <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                          <div className="flex items-center gap-2 mb-2">
                          ...
                          <p className="text-white text-lg font-semibold">{vehicle.vehicle_registry_data.Kategorie}</p>
                        </div>
                      )}
